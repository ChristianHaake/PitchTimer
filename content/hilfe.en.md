...
## Export & Import
You can download your notes at any time as a `.txt` file using the **Save** button, and load them back using the **Open** button.
...
## Deleting Data
You can clear your history at any time using the "Clear History" button. All data is also removed if you clear your browser data (LocalStorage).
